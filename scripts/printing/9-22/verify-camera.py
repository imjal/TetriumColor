...
from TetriumColor.Measurement.SpecimIQ import inspect_hyperspectral_image, extract_grid_from_image
...
def compare_nix_and_camera():
    ...
    selected_spectra = inspect_hyperspectral_image(
        "1338/results/REFLECTANCE_1338.hdr", output_wavelengths=nix_wavelengths)
...
def extract_grid_from_camera_image():
    import numpy as np
    ...
    measured_grid = extract_grid_from_image("1338/results/REFLECTANCE_1338.hdr",
...
if __name__ == "__main__":
    ...
    # extract_grid_from_camera_image()
